...
public class analysisBorrowController implements Initializable {
    ...
    private com.demo.mapper.analysis.personalAnalysis personalAnalysis = AlyServiceFactory.getPersonalAnalysisService();
    ...
    private void initBarChart(){
        ...
        List<personalBorrowAls> personalBorrowAlsList = personalAnalysis.selectBorrowType();
    ...
    private void initPieChart(){
        ...
        List<pubHouseAls> pubHouseAls = personalAnalysis.selectPub();
    ...
    private void initTypePieChart(){
        ...
        List<typeBookAls> typeBookAlsList = personalAnalysis.selectTypePie();
